  ...
  return (
    <Container maxWidth="md" sx={{ py: 4, fontFamily: 'Roboto, sans-serif' }}>
      <Paper sx={{ p: { xs: 2, md: 4 } }}>
        <Typography variant="h3" component="h1" gutterBottom sx={{ textAlign: 'center', mb: 3, fontSize: { xs: '1.8rem', md: '3rem' } }}>
        ...
        <Box sx={{ my: 4 }}>
          <Typography variant="h5" component="h2" gutterBottom sx={{ fontSize: { xs: '1.2rem', md: '1.5rem' } }}>ধাপ ১: একটি ইউটিউব প্লেলিস্ট খুঁজুন</Typography>
          <Typography variant="body1" sx={{ fontSize: { xs: '0.9rem', md: '1rem' } }}>
          ...
          <Box sx={{ my: 2, p: 2, bgcolor: 'grey.100', borderRadius: 1, border: '1px solid', borderColor: 'grey.300' }}>
            <Typography variant="caption" display="block" sx={{ fontSize: { xs: '0.7rem', md: '0.8rem' } }}>উদাহরণ URL:</Typography>
            <Typography component="code" sx={{ fontSize: { xs: '0.8rem', md: '0.9rem' } }}>https://www.youtube.com/playlist?list=PLUvx2CKOD1pllH1JY-F2GgavwYPiQWKyC</Typography>
            <Typography variant="caption" display="block" sx={{ mt: 1, fontSize: { xs: '0.7rem', md: '0.8rem' } }}>উদাহরণ ID:</Typography>
            <Typography component="code" sx={{ fontSize: { xs: '0.8rem', md: '0.9rem' } }}>PLUvx2CKOD1pllH1JY-F2GgavwYPiQWKyC</Typography>
          </Box>
        </Box>

        <Box sx={{ my: 4 }}>
          <Typography variant="h5" component="h2" gutterBottom sx={{ fontSize: { xs: '1.2rem', md: '1.5rem' } }}>ধাপ ২: আপনার প্লেলিস্ট লোড করুন</Typography>
          <Typography variant="body1" sx={{ fontSize: { xs: '0.9rem', md: '1rem' } }}>
        ...
        <Box sx={{ my: 4 }}>
          <Typography variant="h5" component="h2" gutterBottom sx={{ fontSize: { xs: '1.2rem', md: '1.5rem' } }}>ধাপ ৩: মনোযোগ-সহায়ক প্লেয়ার</Typography>
          <Typography variant="body1" sx={{ fontSize: { xs: '0.9rem', md: '1rem' } }}>
          ...
          <List>
            <ListItem>
              ...
              <ListItemText primary="বামে প্রধান ভিডিও প্লেয়ার।" sx={{ fontSize: { xs: '0.9rem', md: '1rem' } }} />
            </ListItem>
            <ListItem>
              <ListItemIcon><CheckCircleOutlineIcon color="primary" /></ListItemIcon>
              <ListItemText primary="ডানে প্লেলিস্টের সমস্ত ভিডিওর একটি পরিচ্ছন্ন তালিকা।" sx={{ fontSize: { xs: '0.9rem', md: '1rem' } }} />
            </ListItem>
          </List>
          <Typography variant="body1" sx={{ fontSize: { xs: '0.9rem', md: '1rem' } }}>
        ...
        <Box sx={{ my: 4 }}>
          <Typography variant="h5" component="h2" gutterBottom sx={{ fontSize: { xs: '1.2rem', md: '1.5rem' } }}>ধাপ ৪: প্লেলিস্ট সেভ ও পরিচালনা করুন</Typography>
          <Typography variant="body1" sx={{ fontSize: { xs: '0.9rem', md: '1rem' } }}>
        ...
        <Box sx={{ my: 4 }}>
          <Typography variant="h5" component="h2" gutterBottom sx={{ fontSize: { xs: '1.2rem', md: '1.5rem' } }}>ধাপ ৫: প্লেলিস্ট ফেভারিট করুন</Typography>
          <Typography variant="body1" sx={{ fontSize: { xs: '0.9rem', md: '1rem' } }}>
        ...
        <Box sx={{ my: 4 }}>
          <Typography variant="h5" component="h2" gutterBottom sx={{ fontSize: { xs: '1.2rem', md: '1.5rem' } }} >ধাপ ৬: ডিসপ্লে কাঁপাকাঁপি সমস্যা</Typography>
        ...
        <Typography variant="h5" component="h2" sx={{ mt: 4, textAlign: 'center', fontSize: { xs: '1.2rem', md: '1.5rem' } }}>
